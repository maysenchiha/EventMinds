...
<body class="events-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="accueil.html" class="logo d-flex align-items-center me-auto">
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Events</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="Completed_Events.php"class="active">Completed events</a></li>
            </ul>
          </li>
          ...
          <div class="row">
           ...
           <div class="col-md-6 d-flex align-items-stretch">
            ...
            <div class="text-center mt-4" style="height: 35px;margin-top: -1.3rem !important;">
                <a href="Comming_events.html" class="read-more" style="background-color: var(--accent-color);
