...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="user_home.html" class="active">Home<br></a></li>
  ...
  <main id="main" class="main">
    <section id="hero" class="hero section dark-background">
      ...
      <img src="assets/img/fond.jpg" alt="" data-aos="fade-in" style="margin-top: -10px;">
      <div class="container">
    ...
    <section id="courses" class="courses section">
      ...
      <div class="text-center mt-4" style="height: 35px;margin-top: 2.3rem !important;"data-aos="zoom-in" data-aos-delay="400">
        <a href="comming.php" class="read-more" style="background-color: var(--accent-color);
        ...
        <div class="row">
            ...
            <div class="col-md-6 d-flex align-items-stretch">
                <div class="card">
                    ...
                    <div class="card-body">
                    <center><h5 class="card-title"><a href=""><?= html_entity_decode($row['titre']); ?></a></h5></center>
                      <center><p class="fst-italic text-center">
                        <?php
                            $dateTime = new DateTime($row['date'] . ' ' . $row['heure']);
                            echo $dateTime->format('l, F jS \a\t g:i A');
          ...
          <div class="text-center mt-4" style="height: 35px;margin-top: -1.3rem !important;">
              <a href="completed.php" class="read-more" style="background-color: var(--accent-color);
              color: white;padding: 10px;border-radius: 30px;">Show More Events</a>
          </div>
      </div>
    </section>
