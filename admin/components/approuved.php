  ...
  <body>
              ...
              <div class="col-md-12">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="multi-filter-select" class="display table table-striped table-hover table-head-bg-success">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <?php
                                    ...
                                    echo '<tr><td colspan="4" class="text-center"> No Approuved Event Yet </td></tr>';
                                }
                            ?>
                            </tbody>
                        </table>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="multi-filter-rejected" class="display table table-striped table-hover table-head-bg-danger">
                        <thead>
                            <tr>
                                <th scope="col">Titre</th>
                                <th scope="col" class="text-center">Date & Time</th>
    ...
    <script>
      $(document).ready(function () {
        ...
        $("#multi-filter-rejected").DataTable({
          pageLength: 5,
          initComplete: function () {
            this.api()
              .columns()
